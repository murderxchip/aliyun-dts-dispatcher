...
// These are the integer logging levels used by the log
type Level int
...
var (
	...
	// log can buffer at a time before writing them.
	LogBufferLength = 32
)
...
// Create a new log with a "stdout" filter configured to send log messages at
...
// all filters (and thus all LogWriters) from the log.
